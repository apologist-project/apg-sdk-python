...
from apologist_agent.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from apologist_agent.core.request_options import RequestOptions
...
@patch("apologist_agent.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("apologist_agent.core.http_client.asyncio.sleep", new_callable=AsyncMock)
