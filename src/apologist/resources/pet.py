...
class PetResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> PetResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/apologist-project/apg-sdk-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> PetResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/apologist-project/apg-sdk-python#with_streaming_response
        """
