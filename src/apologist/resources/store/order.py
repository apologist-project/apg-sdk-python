...
class OrderResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> OrderResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/apologist-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> OrderResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/apologist-python#with_streaming_response
        """
